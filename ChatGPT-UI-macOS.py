...
from PyQt5.QtWidgets import (
    ...
    QTextEdit, QLabel, QComboBox, QSpinBox, QAction, QMenuBar, QDialog, QGroupBox, QMenu
)
...
class GPTUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.group_box0 = QGroupBox(self)

        layout_menu = QHBoxLayout()
        layout_menu2 = QHBoxLayout()
        ...
        menu_bar.addAction(updates_action)
        menu_bar.addAction(star_action)
        menu_bar.addAction(about_action)
        menu_bar.addSeparator()  # Add a separator between items
        menu_bar.addAction(exit_action)
        self.help_button.setMenu(menu_bar)
        layout_menu.addWidget(self.help_button)
        ...
        layout_menu2.addWidget(self.proxy_checkbox_label)
        ...
        layout_menu2.addWidget(self.proxy_checkbox)
        ...
        layout_menu2.addWidget(self.switch_control_label)
        ...
        layout_menu2.addWidget(switch_control)

        switch_control.toggled.connect(self.theme_switch_button_changed)
        layout_menu.setAlignment(Qt.AlignLeft)
        layout_menu2.setAlignment(Qt.AlignRight)


        # Add both layouts to the group box
        self.group_box0.setLayout(QHBoxLayout())  # QVBoxLayout for stacking two rows
        self.group_box0.layout().addLayout(layout_menu)
        self.group_box0.layout().addLayout(layout_menu2)

        layout.addWidget(self.group_box0)
